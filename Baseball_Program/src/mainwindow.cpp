...
void MainWindow::setupConnections()
{
    ...
    connect(ui->manageSouvenirsButton, &QPushButton::clicked, this, &MainWindow::manageSouvenirs);
}
...
void MainWindow::manageSouvenirs()
{
    QString selectedTeam = ui->teamComboBox->currentText();
    if (selectedTeam.isEmpty()) {
        QMessageBox::warning(this, tr("No Team Selected"),
                           tr("Please select a team first."));
        return;
    }
    
    SouvenirDialog dialog(selectedTeam, this);
    dialog.exec();
} 