...
bool Database::initialize()
{
    ...
    createTables();
    insertInitialData();
    initializeSouvenirs();  // Initialize souvenirs after teams are created
    return true;
}
...
bool Database::importFromCSV(const QString &csvFilePath)
{
    ...
    clearQuery.exec("DELETE FROM Souvenirs"); // Also clear souvenirs since we're deleting teams
    ...
    // Initialize souvenirs for all teams
    initializeSouvenirs();
