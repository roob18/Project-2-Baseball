...
public:
    ...
    QPushButton *manageSouvenirsButton;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        manageSouvenirsButton = new QPushButton(centralwidget);
        manageSouvenirsButton->setObjectName("manageSouvenirsButton");

        buttonLayout->addWidget(manageSouvenirsButton);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        manageSouvenirsButton->setText(QCoreApplication::translate("MainWindow", "Manage Souvenirs", nullptr));
    } // retranslateUi
